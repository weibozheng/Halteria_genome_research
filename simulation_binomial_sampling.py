...
import random
inf1=open(r"/N/dc2/projects/ciliate/Halteria_grandinella/Halteria_Nuohe/Hal_v3_genome_1.pol")#original heterozygous file
total_reads=186978547

list_b=list()
dict_o=dict()
out=open(r"/N/dc2/projects/ciliate/Halteria_grandinella/Halteria_Nuohe/sim.tab","w")#simulated by binomial sampling
new=1
for line in inf1:
	if new==1:
		new=0
