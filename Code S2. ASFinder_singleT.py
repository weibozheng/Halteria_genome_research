...
#This source code is not published, only for information
#This softeware can detect the DNA splicing event using NGS datasets. Bowtie2, biopython, and python3 is required.
def r_m_l(astr):
