use LWP::Simple;
open(FH1,'C:\Users\wbzheng\Halteria_Nuohe\Hal_SPCA\DE\lastest\all_annotated_genes_gi_exp.txt');
open(out,'>','C:\Users\wbzheng\Halteria_Nuohe\Hal_SPCA\DE\lastest\all_annotated_genes_gi_exp.comment');
@datassssss=<FH1>;
